...
HotkeyManager::HotkeyManager(QObject *parent)
    : QObject{parent}
{
    m_pauseHotkey = new QHotkey(QKeySequence("Q"), true, this);
    m_splitHotkey = new QHotkey(QKeySequence("W"), true, this);
    m_resetHotkey = new QHotkey(QKeySequence("E"), true, this);
